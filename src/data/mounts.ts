...
export const TAMING_TOOLS: Record<TamingToolId, TamingToolDefinition> = {
  lasso: {
    ...
    name: 'Lasso',
    price: 150,
    description: 'Basic rope snare. Small target, fast needle. Precision required.',
  ...
  tranq_gun: {
    ...
    price: 1500,
    description: 'Sedative dart rifle. Medium target, standard speed. Steady hands.',
  ...
  mesmetron: {
    ...
    name: 'Mesmetron',
    price: 8000,
    description: 'Neural pacifier as seen on TV. Wide target, slow cursor. Near-certain compliance.',
