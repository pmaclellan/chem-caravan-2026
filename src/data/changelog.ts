...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: 'Jul 2, 2026',
    items: [
      '15+ new achievements: Pacifist, Toll Evader, Butt Clencher, Friends with Benefits, Bear Tamer, and more',
      'Achievement toasts now cycle through multiple unlocks with a progress bar',
      'Taming mini-game is harder across all tools — especially the Mesmetron',
