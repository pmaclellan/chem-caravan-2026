...
export const TRANSIT_QUOTES: TransitQuote[] = [
  ...
  { text: "Made enough off one Stimpak run to pay my Bunker Hill rent for a year. One year.", speaker: "Caravan guard" },
  { text: "Three years I ran Ultrajet. Now everyone wants Mentats. The market is a cruel mistress.", speaker: "Weathered chem runner" },
  { text: "A wise woman told me: buy low, sell high, don't die. Wisest woman I ever met.", speaker: "Old cap trader" },
  { text: "You can smell the markup on every chem in Goodneighbor. They don't even try to hide it.", speaker: "Diamond City merchant" },
  { text: "Pre-war money. Still carrying pre-war money. My grandfather's idea. Grandfather was an idiot.", speaker: "Cap dealer" },
  { text: "Nobody wins in a chem deal. Somebody just loses less.", speaker: "Retired triggerman" },
  ...
  { text: "I quit Jet. Twice. Working on a third.", speaker: "Very honest raider" },

  // Wasteland philosophy
  { text: "I used to have a five-year plan. The bombs went off in year two.", speaker: "Pre-war survivor" },
  { text: "The caps are the caps you made along the way.", speaker: "Suspiciously philosophical raider" },
