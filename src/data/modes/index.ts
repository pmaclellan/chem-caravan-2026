...
const MOJAVE_WASTELAND_MODE: GameModeConfig = {
  ...
  mapPositions: {
    ...
    ncr_sharecropper_farms: { x: 380, y: 260, labelAnchor: 'start',  labelDx:  13, labelDy:   4 },
    camp_mccarran:          { x: 300, y: 300, labelAnchor: 'start',  labelDx:  13, labelDy:   4 },
    helios_one:             { x: 500, y: 400, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    red_rock_canyon:        { x: 200, y: 260, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    sloan:                  { x: 310, y: 360, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    goodsprings:            { x: 220, y: 400, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    primm:                  { x: 260, y: 560, labelAnchor: 'middle', labelDx:   0, labelDy:  18 },
    novac:                  { x: 480, y: 500, labelAnchor: 'start',  labelDx:  13, labelDy:   4 },
    nelson:                 { x: 530, y: 520, labelAnchor: 'middle', labelDx:   0, labelDy:  16 },
  },
}
