...
const CAPITAL_WASTELAND_MODE: GameModeConfig = {
  ...
  mapPositions: {
    little_lamplight:   { x: 160, y: 160, labelAnchor: 'middle', labelDx:   0, labelDy: -15 },
    canterbury_commons: { x: 260, y: 160, labelAnchor: 'middle', labelDx:   0, labelDy: -15 },
    arefu:              { x: 360, y: 160, labelAnchor: 'middle', labelDx:   0, labelDy: -15 },
    megaton:            { x: 360, y: 260, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    underworld:         { x: 460, y: 260, labelAnchor: 'start',  labelDx:  13, labelDy:   4 },
    rivet_city:         { x: 460, y: 360, labelAnchor: 'start',  labelDx:  13, labelDy:   4 },
    the_citadel:        { x: 360, y: 360, labelAnchor: 'middle', labelDx:   0, labelDy:  18 },
    tenpenny_tower:     { x: 260, y: 360, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    andale:             { x: 260, y: 460, labelAnchor: 'middle', labelDx:   0, labelDy:  16 },
  },
}
