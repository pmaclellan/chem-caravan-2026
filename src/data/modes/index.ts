...
const COMMONWEALTH_MODE: GameModeConfig = {
  ...
  mapPositions: {
    ...
    concord:                  { x: 200, y: 260, labelAnchor: 'middle', labelDx:   0, labelDy: -15 },
    ...
    park_street_station:      { x: 440, y: 420, labelAnchor: 'middle', labelDx:   0, labelDy: -15 },
    diamond_city:             { x: 280, y: 410, labelAnchor: 'middle', labelDx:   0, labelDy:  18 },
    vault_81:                 { x: 180, y: 400, labelAnchor: 'end',    labelDx: -13, labelDy:   4 },
    somerville_place:         { x: 150, y: 560, labelAnchor: 'middle', labelDx:   0, labelDy:  16 },
    jamaica_plain:            { x: 460, y: 500, labelAnchor: 'middle', labelDx:   0, labelDy:  16 },
    the_castle:               { x: 560, y: 530, labelAnchor: 'middle', labelDx:   0, labelDy:  16 },
  },
}
...
const MOJAVE_WASTELAND_MODE: GameModeConfig = {
  ...
  enemyStats: {
    ...
    feral_ghoul:   { health: 30,  damage: [15, 25], xpReward: 10 },
    legionnaire:   { health: 70,  damage: [22, 42], xpReward: 35 },
    deathclaw:     { health: 140, damage: [50, 90], xpReward: 100 },
    radscorpion:   { health: 70,  damage: [20, 42], xpReward: 30 },
    ...
    ncr_ranger:    { health: 110, damage: [28, 50], xpReward: 90 },
  },
